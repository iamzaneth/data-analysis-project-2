...
-- Suggested charts: monthly line chart, category bar chart, treemap/pie chart,
-- state ranking table, combo chart for GMV and freight.
-- Expected insights: growth trends, top categories/regions, freight-heavy
-- segments, and revenue concentration.
