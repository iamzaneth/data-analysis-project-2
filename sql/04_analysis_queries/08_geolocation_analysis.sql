...
-- Suggested charts: map chart, regional ranking, city bar chart, risk scatter.
-- Expected insights: high-value regions, underserved regions, regions with high
-- delivery/review risk, and geographic concentration.
