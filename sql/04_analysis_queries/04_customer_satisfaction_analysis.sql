...
-- Suggested charts: KPI cards, monthly line chart, stacked bar, state ranking,
-- late-vs-on-time comparison.
-- Expected insights: whether late delivery correlates with low reviews, which
-- regions need service improvement, and whether customers leave comments when
-- satisfaction drops.
