...
-- Suggested charts: KPI cards, monthly line chart, bar chart, map chart,
-- delivered-vs-late combo chart.
-- Expected insights: regions and periods with high late rate, long delivery
-- duration, and high business impact.
