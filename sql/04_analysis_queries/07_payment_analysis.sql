...
-- Suggested charts: KPI cards, pie chart by payment type, stacked bar by month,
-- state ranking, installment distribution table.
-- Expected insights: dominant payment methods, installment-heavy regions, and
-- payment types with high average order value.
