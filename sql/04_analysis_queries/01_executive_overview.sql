...
-- Suggested charts: KPI cards, monthly line chart, combo chart, year/month summary table.
-- Expected insights: overall business size, revenue trend, order volume, review health,
-- payment volume, freight burden, and delivery risk.
