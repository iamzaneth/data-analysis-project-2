...
DROP INDEX IF EXISTS mart.idx_mart_sales_category;

CREATE INDEX IF NOT EXISTS idx_mart_sales_category
    ON mart.mart_sales (product_category_name);
